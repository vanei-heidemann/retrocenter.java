...
*/
    ...
    public LBoxMetadata parseMetadata(File lbDir) throws Exception {
        ...
        this.parseMetadata(metadata, new File(lbDir, "Metadata/Metadata.xml"));
        this.parseFiles(metadata, new File(lbDir, "Metadata/Files.xml"));
        return metadata;
    }

    private void parseFiles(LBoxMetadata metadata, File file) throws Exception {
    ...
    private void parseMetadata(LBoxMetadata metadata, File file) throws Exception {
        DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
        factory.setIgnoringComments(true);
        factory.setValidating(false);
        DocumentBuilder builder = factory.newDocumentBuilder();
